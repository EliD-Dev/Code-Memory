...
import { MentionsLegales, Confidentialite, CGU } from './LegalPageLayout';
...
function AppContent() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 font-sans py-12 px-4 sm:px-6 lg:px-8">
            ...
            {/* Footer minimaliste */}
            <footer className="border-t border-slate-200 py-6 mt-12 text-center text-sm text-slate-500 font-sans">
                <p className="mb-2">Copyright 2026 <a href="https://eli-dev.fr/" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-slate-950 font-semibold underline decoration-slate-400">EliDev</a>. {t('legal.copyright')}</p>
                <div className="flex justify-center gap-4 text-xs font-medium">
                    <Link to="/mentions-legales" className="text-slate-500 hover:text-slate-950 transition-colors decoration-transparent">
                        {t('legal.links.mentions')}
                    </Link>
                    <Link to="/confidentialite" className="text-slate-500 hover:text-slate-950 transition-colors decoration-transparent">
                        {t('legal.links.privacy')}
                    </Link>
                    <Link to="/cgu" className="text-slate-500 hover:text-slate-950 transition-colors decoration-transparent">
                        {t('legal.links.cgu')}
                    </Link>
                </div>
            </footer>
